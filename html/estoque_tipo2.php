                            ...
                            case 'Almôndegas': ?>
                                ...
                                foreach ($pacotes_produtos2 as $pac_prod_2un) {
                                  foreach ($pacotes_produtos6 as $pac_prod_6un){
                                    ...
                                    <td>
                                    ';
                                  if (isset($pac_prod_2un->saldo)) {  echo $pac_prod_2un->saldo; } elseif (isset($pac_prod_2un->entradas)){  echo $pac_prod_2un->entradas; }else{echo 0;}
                                    ; echo'
                                    </td>
                                    <td>
                                    ';

                                    if (isset($pac_prod_6un->saldo)) {  echo $pac_prod_6un->saldo; } elseif (isset($pac_prod_6un->entradas)){  echo $pac_prod_6un->entradas; }else{echo 0;}
                                    ; echo'
                                    </td>
                                    <td>
                                    ';
                                    // echo $pac_prod_9un->entradas;
                                    if (isset($pac_prod_9un->saldo)) {  echo $pac_prod_9un->saldo; } elseif (isset($pac_prod_9un->entradas)){  echo $pac_prod_9un->entradas; }else{echo 0;}
