        ...
        foreach ($produto as $prod) {
          ...
          sum(el.quantidade) from log_estoque as el
            ...
            if (empty($pacotes_produtos9) ){ $pacotes_produtos9 = ['0' => '0'];}
                          ...
                          if (isset($pac_prod_5un->saldo)) {  echo $pac_prod_5un->saldo; } elseif (isset($pac_prod_5un->entradas)){  echo $pac_prod_5un->entradas; }else{echo 0;}
                          ; echo'
                          </td>
                          <td>
                          ';

                          if (isset($pac_prod_10un->saldo)) {  echo $pac_prod_10un->saldo; } elseif (isset($pac_prod_10un->entradas)){  echo $pac_prod_10un->entradas; }else{echo 0;}
